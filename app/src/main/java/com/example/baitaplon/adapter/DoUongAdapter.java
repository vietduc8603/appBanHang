...
import com.example.baitaplon.Interface.ItemClickListener;
import com.example.baitaplon.R;
import com.example.baitaplon.activity.ChiTietActivity;
...
public class DoUongAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyViewHolder(@NonNull View itemView){
            super(itemView);
            tensp = itemView.findViewById(R.id.itemdouong_ten);
            giasp = itemView.findViewById(R.id.itemdouong_gia);
            mota = itemView.findViewById(R.id.itemdouong_mota);
            hinhanh = itemView.findViewById(R.id.itemdouong_img);
